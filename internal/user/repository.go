...
type Repository interface {
	...
	AddNotification(c *gin.Context, ID int, senderID int, notificationType string, questName string, teamID int, actualTime time.Time) error
...
func (r *repository) GetUser(c *gin.Context, id int) (domain.UserDTO, domain.User, error) {
	...
	return domain.UserDTO{ID: id, Username: user.Username, Email: user.Email, Name: user.Name, Password: user.Password}, user, nil
}
...
func (r *repository) AddNotification(c *gin.Context, userID int, senderID int, notificationType string, questName string, teamID int, actualTime time.Time) error {

	notification := domain.Notification{SenderID: senderID, ReceiverID: userID, Type: notificationType, SentTime: actualTime, QuestName: questName, TeamID: teamID}
